...
.directive("acSelect", function ($parse, acuteSelectService) {
    ...
    return {
        ...
        replace: true,
        templateUrl: "lib/acute-select/acute/acute.select/template/acute.select.htm",
        link: function (scope, element, attrs) {
            ...
            var data = attrs.data;
            if (data === undefined) {
                throw "data attributes must be set";
            }else{
                scope.fieldName = data.charAt(0).toUpperCase() + data.slice(1);
            }
...
.factory('acuteSelectService', function () {
    ...
    var defaultSettings = {
        ...
        "noItemsText": "Sorry,can't find the value that you are looking for",
        "itemHeight": 24,
        "itemsInView": 10,
        "minWidth": "100px",
        "showSearchBox": true,
